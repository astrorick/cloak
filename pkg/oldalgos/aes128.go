...
func (algo *AES128) Description() string {
	return "AES symmetric encryption (128-bit)"
}

func (algo *AES128) Encrypt(input io.Reader, output io.Writer, psw string) error {
	// read source file
...
func (algo *AES128) Decrypt(input io.Reader, output io.Writer, psw string) error {
